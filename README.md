...
6. If you did everything correct, https://&#34;.github.io/&#34;/ will lead to your new docs
...
- Documentation(ReDoc): https://&#34;.github.io/&#34;/
- SwaggerUI: https://&#34;.github.io/&#34;/swagger-ui/
- Look full spec:
    + JSON https://&#34;.github.io/&#34;/swagger.json
    + YAML https://&#34;.github.io/&#34;/swagger.yaml
- Preview spec version for branch `[branch]`: https://&#34;.github.io/&#34;/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://&#34;.github.io/&#34;/ with url from the message: `Server started <url>`
